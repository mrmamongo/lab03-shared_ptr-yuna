...
TEST(SharedPtr_Test, Counter_Test) {
  ...
  EXPECT_TRUE(pvalue1.GetCount() == 2);
  EXPECT_TRUE(pvalue2.GetCount() == 2);
}
...
TEST(SharedPtr_Test, Pointer_Test) {
  ...
  EXPECT_TRUE(*pvalue1 == 5);
  EXPECT_TRUE(*pvalue2 == 5);
  ...
  EXPECT_TRUE(pvalue3->value == 10);
  EXPECT_TRUE(pvalue4->value == 10);
}
...
TEST(SharedPtr_Test, Get_Test) {
  ...
  EXPECT_TRUE(pvalue1.Get() == pvalue);
  EXPECT_TRUE(pvalue2.Get() == pvalue);
}
...
TEST(SharedPtr_Test, Swap_Test) {
  ...
  EXPECT_TRUE(pvalue1.GetCount() == 3);
  EXPECT_TRUE(pvalue3.GetCount() == 2);

  EXPECT_TRUE(*pvalue1 == 10);
  EXPECT_TRUE(*pvalue3 == 5);
